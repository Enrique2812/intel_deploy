            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body text-start ">
                        ...
                        <!-- Modal -->
                        <div class="modal fade bd-example-modal-lg text-start" tabindex="-1" role="dialog" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Ingrese Profesor</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal">
                                        </button>
                                    </div>
                                    <form class="needs-validation" novalidate method="POST" action="/crear/profesores">
                                            ...
                                            <div class="form-validation">
                                                <div class="row">
                                                    <div class="col-xl-6">
                                                        ...
                                                        <div class="mb-3">
                                                            <label class="col-form-label" for="tipo_usuario">Tipo <span class="text-danger">*</span></label>
                                                            <div class="col-xl-12 mb-3">
                                                                <select name="tutor" id="tipo_usuario" class="nice-select form-control default-select dashboard-select-2 h-auto wide" required>
                                                    ...
                                                    <div class="col-xl-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="input-group transparent-append">
                                                                ...
                                                                <input type="password" class="form-control" id="dlab-password1" name="usuario[password]" placeholder="Introduzca una contraseña" required>
                                                ...
                                                <td>
                                                    <?php foreach ($profesores as $profesor) : ?>
                                                        <?php if ($profesor->id_usuario === $usuario->id) : ?>
                                                            <?php if ($profesor->tutor === '0'): ?>
                                                                <?php echo 'Profesor' ?>
                                                            <?php elseif ($profesor->tutor === '1'): ?>
                                                                <?php echo 'Tutor' ?>
                                                            <?php else : ?>
                                                                <?php echo 'Sin seleccionar' ?>
                                                            <?php endif; ?>
                                                        <?php endif; ?>
                                                    <?php endforeach; ?>
                                                </td>
                                                ...
                                                <div class="modal fade bd-example-modal-lg edit" id="editModal-<?php echo $usuario->id; ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                                    <div class="modal-dialog modal-lg text-start">
                                                        <div class="modal-content">
                                                            ...
                                                            <form class="needs-validation" novalidate method="POST" action="/editar/profesores">
                                                                <div class="modal-body">

                                                                    <div class="form-validation">
                                                                        <div class="row">
                                                                            <div class="col-xl-6">
                                                                                <input value="<?php echo $usuario->idaño ?>" type="hidden" class="form-control" id="dni" name="usuario[idaño]" placeholder="Introduzca el DNI" required>
                                                                                <div class="mb-3">
                                                                                ...
                                                                                <div class="mb-3">
                                                                                    <label class="col-form-label" for="tipo_usuario">Tipo <span class="text-danger">*</span></label>
                                                                                    <select name="profesor[tutor]" class="nice-select form-control default-select dashboard-select-2 h-auto wide">
                                                                                        <?php foreach ($profesores as $profesor) : ?>
                                                                                            <?php if ($profesor->id_usuario === $usuario->id) : ?>
                                                                                                <?php if ($profesor->tutor === '0'): ?>
                                                                                                    <option value="0" selected>Profesor</option>
                                                                                                    <option value="1">Tutor</option><input value="<?php echo $usuario->id ?>" type="hidden" class="form-control" name="usuario[id]" placeholder="Introduzca un nombre de usuario.." required>
                                                                                                    <input value="<?php echo $profesor->id ?>" type="hidden" class="form-control" name="profesor[id]" placeholder="Introduzca un nombre de usuario.." required>
                                                                                                    <input value="<?php echo $profesor->id_usuario ?>" type="hidden" class="form-control" name="profesor[id_usuario]" placeholder="Introduzca un nombre de usuario.." required>

                                                                                                <?php elseif ($profesor->tutor === '1'): ?>
                                                                                                    <option value="1" selected>Tutor</option>
                                                                                                    <option value="0">Profesor</option> <input value="<?php echo $profesor->id ?>" type="hidden" class="form-control" name="profesor[id]" placeholder="Introduzca un nombre de usuario.." required>
                                                                                                    <input value="<?php echo $profesor->id_usuario ?>" type="hidden" class="form-control" name="profesor[id_usuario]" placeholder="Introduzca un nombre de usuario.." required>
                                                                            ...
                                                                            <div class="col-xl-6">
                                                                                <div class="mb-3">
                                                                                    <label class="col-form-label" for="tipo_usuario">Sexo <span class="text-danger">*</span></label>
                                                                                    <select name="usuario[sexo]" class="nice-select form-control default-select dashboard-select-2 h-auto wide">
