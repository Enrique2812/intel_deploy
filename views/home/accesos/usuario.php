                        ...
                        <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <form class="needs-validation" novalidate method="POST" action="/crear/usuario">
                                            ...
                                            <div class="form-validation">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-6">
                                                        ...
                                                        <div class="mb-3">
                                                            <label class="col-form-label" for="anio">Año <span class="text-danger">*</span></label>
                                                            <input type="number" class="form-control" id="anio" name="usuario[anio]" placeholder="Introduzca el año" required>
                                                            <div class="invalid-feedback">
                                                                Debes introducir un año válido.
                                                            </div>
                                                        </div>


                                                        <div class="mb-3">
                                                            <label class="col-form-label" for="id_rol">Rol <span class="text-danger">*</span></label>
                                                            <div class="col-xl-12 mb-3">
                                                                <select id="id_rol" name="usuario[id_rol]" class="nice-select form-control default-select dashboard-select-2 h-auto wide" required>
                                                                    <option value="" selected disabled>Abrir selección</option>
                                                                    <?php foreach ($roles as $rol) : ?>
                                                                        <?php if ($rol->id !== '4' && $rol->id !== '5') : // Omitimos los roles de alumno y profesor ?>
                                                        ...
                                                        <script>
                                                            document.addEventListener('DOMContentLoaded', (event) => {
                                                                ...
                                                                const form = rolSelect.closest('form');

                                                                form.addEventListener('submit', (e) => {
                                                                    if (rolSelect.value === "") {
                                                                        rolSelect.setCustomValidity('Debes seleccionar un rol.');
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="d-flex">
                                                            ...
                                                            <a href="#" class="btn btn-danger shadow btn-xs sharp" data-bs-toggle="modal" data-bs-target="#deleteModal-<?php echo $usuario->id; ?>"><i class="fa fa-trash"></i></a>
                                                        </div>
                                                    </td>
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <a href="/eliminar/usuario?id=<?php echo $usuario->id ?>" class="btn btn-danger">Confirmar</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="modal fade bd-example-modal-lg edit" id="editModal-<?php echo $usuario->id; ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                                        <div class="modal-dialog modal-lg">
                                                            <div class="modal-content">
                                                                ...
                                                                <form class="needs-validation" novalidate method="POST" action="/editar/usuario">
                                                                    <div class="modal-body">
                                                                        <div class="form-validation">
                                                                            <div class="row">
                                                                                <div class="col-xl-6">
                                                                                    ...
                                                                                    <div class="mb-3">
                                                                                        ...
                                                                                        <input value="<?php echo $usuario->dni ?>" type="text" class="form-control" id="dni" name="usuario[dni]" placeholder="Introduzca el DNI" readonly>
                                                                                    </div>
                                                                                ...
                                                                                <div class="col-xl-6">
                                                                                    ...
                                                                                    <div class="mb-3">
                                                                                        <label class="col-form-label" for="id_rol">Rol <span class="text-danger">*</span></label>
                                                                                        <div class="col-xl-12 mb-3">
                                                                                            <select name="usuario[id_rol]" id="id_rol" class="nice-select form-control default-select dashboard-select-2 h-auto wide" required>
                                                                                                <?php foreach ($roles as $rol) : ?>
                                                                                                    <?php if ($rol->id !== '5' && $rol->id !== '4'): ?>
                                                                                ...
                                                                                <div class="col-xl-12">
                                                                                    <div class="mb-3">
                                                                                        ...
                                                                                        <div class="input-group">
                                                                                            <span class="input-group-text"><i class="fa fa-lock"></i></span>
                                                                                            <input type="password" class="form-control" id="dlab-password<?= $index ?>" name="usuario[password<?= $index ?>]" placeholder="Introduzca una contraseña" required>
